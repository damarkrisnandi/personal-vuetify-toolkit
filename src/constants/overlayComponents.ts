// Overlay Components Code Constants
export const MODAL_CODE = `<template>
  <div>
    <!-- Basic Modal -->
...
export const DRAWER_CODE = `<template>
  <div>
    <!-- Temporary Drawer -->
    ...
    <v-navigation-drawer v-model="temporaryDrawer" temporary location="right" width="300">
      <v-card flat>
        ...
        <v-card-text>
          <p>This drawer appears temporarily and can be closed by clicking outside or using the close button.</p>
          <v-list>
...
export const TOAST_CODE = `<template>
...
export const TOOLTIP_CODE = `<template>
...
export const MENU_CODE = `<template>
